\begin{titlepage}
	...
	\centering
	\includegraphics[scale=0.6]{./res/logo} \break % вставка логотипа
	МИНОБРНАУКИ РОССИИ\\
	...
	по дисциплине <<Сопровождение программных систем>>\\
	\vfill
	\textbf{\large Практическое задание \No\,2}\\
	\textbf{<<Администрирование компьютера
		в рабочей группе Microsoft Windows>>}
	\vfill
	\vfill
	\begin{tabular}{llr}
		Студент группы
